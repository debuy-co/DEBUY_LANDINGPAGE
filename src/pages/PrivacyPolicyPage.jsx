      ...
      <main className="terms-page">
        <div className="terms-container">
          ...
          <div className="terms-header">
            <h1>Privacy Policy of Debuy</h1>
            <p className="terms-subtitle">
              Welcome to the privacy policy of Debuy. This policy will help you
              understand what data we collect, why we collect it, and what your
          ...
          <section className="terms-section">
            ...
            <ul>
              ...
              <li>
                <a href="#mode">Mode and place of processing the Data</a>
              </li>
              <li>
                <a href="#purposes">The purposes of processing</a>
              </li>
              <li>
          ...
          {/* 2 */}
          <section className="terms-section" id="types">
          ...
          {/* 3 */}
          <section className="terms-section" id="mode">
          ...
          <section className="terms-section" id="purposes">
            ...
            <p>
              ...
              activity, as well as the following: Analytics, Contacting the
              User, Managing contacts and sending messages and Registration and
              authentication.
            </p>
            <p>
          ...
          {/* 6 */}
          <section className="terms-section" id="eu">
          ...
          {/* 7 */}
          <section className="terms-section" id="additional">
